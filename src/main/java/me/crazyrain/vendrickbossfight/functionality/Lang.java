...
public enum Lang {
    ...
    STARNAME("star-name", "&b&lEternal Star"),
    ...
    DSTARNAME("dstar-name", "&5&lDistorted &b&lEternal Star"),
    ...
    VSTARNAME("vstar-name","&f&lVolatile Star"),
    ...
    RAREDROP("rare-drop" ,"&6&lNICE! &6You found:"),
    EPICTIER("epic-tier", "&5Epic &8Tier"),
    EPICDROP("epic-drop", "&d&lWOW! &6You found:"),
    SPECIALTIER("special-tier", "&dSpecial &8Tier"),
    SPECIALDROP("special-drop", "&c&lINCREDIBLE! &6You found:"),
    ...
    STORMSTARDESC3("storm-star-desc3", "&7It's about to get &oelectrifying!."),
    ...
    VIEWRECIPE("ven-view-recipe", "&bRight-click to view recipes")
    ;
