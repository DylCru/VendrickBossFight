...
public class Hurricane {
    ...
    private void stormEffects(){
        new BukkitRunnable(){
            ...
            public void run() {
                ...
                for (Entity e : vendrick.getEntity().getNearbyEntities(radius, 2, radius)){
                    ...
                    if (plugin.getFightManager().isVenSpawned()) {
                        ...
                        player.damage(damage, plugin.getFightManager().getVendrick().getEntity());
    ...
    private void spawnCircle(){
        new BukkitRunnable(){
            ...
            public void run() {
                if (plugin.getFightManager().isVenSpawned()){
                    makeCircle(vendrick.getEntity().getLocation(), radius, Color.MAROON);
                } else {
                    cancel();
                }
